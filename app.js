...
function App(){
  ...
  return React.createElement("div",{style:S.page},
    ...
    previewPhoto&&React.createElement("div",{
      style:S.previewOverlay,
      onClick:function(){setPreviewPhoto(null);}
    },
      React.createElement("div",{style:S.previewContainer,onClick:function(e){e.stopPropagation();}},
        React.createElement("div",{style:S.previewHeader},
          React.createElement("span",{style:{color:"#fff",fontWeight:700,fontSize:15}},
            previewPhoto.label+" — Check Clarity"
          ),
          React.createElement("button",{style:S.previewClose,onClick:function(){setPreviewPhoto(null);}},"✕")
        ),
        React.createElement("div",{style:S.previewImgWrap},
        ...
        React.createElement("div",{style:S.previewHint},"👆 Pinch to zoom • Check photo clarity"),
        React.createElement("div",{style:S.previewActions},
          React.createElement("button",{
            style:{flex:1,background:"#dc2626",color:"#fff",border:"none",borderRadius:10,padding:"13px",fontSize:14,fontWeight:700,cursor:"pointer"},
            onClick:function(){
              setPreviewPhoto(null);
              openCamera(previewPhoto.slotId);
            }
          },"📷 Retake"),
          React.createElement("button",{
            style:{flex:1,background:"#15803d",color:"#fff",border:"none",borderRadius:10,padding:"13px",fontSize:14,fontWeight:700,cursor:"pointer"},
            onClick:function(){setPreviewPhoto(null);}
          },"✅ OK — Keep")
        )
      )
              ...
              cap
                ?React.createElement(React.Fragment,null,
                    ...
                    !cap.processing&&React.createElement("div",{style:S.photoBar},
                      ...
                      React.createElement("button",{style:Object.assign({},S.retakeBtn,{background:"#eff6ff",color:"#1d4ed8",border:"1px solid #bfdbfe"}),
...
var S={
  ...
  previewOverlay :{position:"fixed",inset:0,background:"rgba(0,0,0,0.95)",zIndex:250,display:"flex",flexDirection:"column"},
  previewContainer:{display:"flex",flexDirection:"column",height:"100vh"},
  previewHeader :{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"16px 20px",background:"rgba(0,0,0,0.8)"},
  ...
  previewImgWrap:{flex:1,overflow:"auto",display:"flex",alignItems:"center",justifyContent:"center"},
  previewImg    :{maxWidth:"100%",maxHeight:"100%",objectFit:"contain",touchAction:"pinch-zoom"},
  previewHint   :{textAlign:"center",color:"rgba(255,255,255,0.6)",fontSize:12,padding:"10px"},
  previewActions:{display:"flex",gap:12,padding:"16px 20px",background:"rgba(0,0,0,0.8)"},
