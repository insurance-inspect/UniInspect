...
const BACKEND_URL = "https://script.google.com/macros/s/AKfycbyfRKHS0b3IGFvqkQQJuxUr97vJsxn6SNcOXYEGiuUZPke76KjiexsQWIrjCIZxh54YSA/exec";
...
function AdminPanel(props){
  ...
  var utab=useState("offices"); var tab=utab[0],    setTab=utab[1];
  ...
  async function login(){
    setLoading(true);
    var result=await backendPost({action:"validateAdmin",password:adminPass});
    setLoading(false);
    if(result.success){
      setAuthed(true);loadAll();
    } else {
      setAdminErr(result.error||"Wrong password");
    }
  }
  ...
  async function loadAll(){
    setLoading(true);
    try {
      var off=await backendGet("getOffices");
      setOffices(Array.isArray(off)?off:[]);
      var bk=await backendGet("getBrevoKeys");
      setBrevoKeys(Array.isArray(bk)?bk:[]);
      var st=await backendGet("getStats");
  ...
  return React.createElement("div",{style:S.adminOverlay},
    React.createElement("div",{style:Object.assign({},S.adminModal,{maxWidth:480,maxHeight:"90vh",overflowY:"auto",padding:0})},
      ...
      React.createElement("div",{style:{display:"flex",borderBottom:"1px solid #e2e8f0",background:"#f8fafc"}},
        [["offices","🏢 Offices"],["brevo","🔑 Brevo"],["stats","📊 Stats"]].map(function(t){
          return React.createElement("button",{key:t[0],
            style:{flex:1,padding:"10px 4px",border:"none",
              borderBottom:tab===t[0]?"2px solid #1d4ed8":"2px solid transparent",
              background:"transparent",fontSize:11,
              fontWeight:tab===t[0]?700:400,
              color:tab===t[0]?"#1d4ed8":"#64748b",cursor:"pointer"},
      ...
      React.createElement("div",{style:{padding:"16px"}},
        ...
        tab==="offices"&&React.createElement("div",null,
          ...
          React.createElement("input",{style:Object.assign({},S.input,{marginBottom:8,fontSize:12}),placeholder:"Office Code (e.g. 300601)",value:newOffice.code,
            onChange:function(e){setNewOffice(function(o){return Object.assign({},o,{code:e.target.value.toUpperCase()});})}}),
          React.createElement("input",{style:Object.assign({},S.input,{marginBottom:8,fontSize:12}),placeholder:"Office Name",value:newOffice.name,
            onChange:function(e){setNewOffice(function(o){return Object.assign({},o,{name:e.target.value});})}}),
          React.createElement("input",{style:Object.assign({},S.input,{marginBottom:8,fontSize:12}),placeholder:"Recipient Email",value:newOffice.email,
            onChange:function(e){setNewOffice(function(o){return Object.assign({},o,{email:e.target.value});})}}),
          React.createElement("button",{style:Object.assign({},S.btn,{width:"100%",marginBottom:16,fontSize:13}),onClick:saveOffice},"+ Add Office"),
          React.createElement("div",{style:{fontWeight:700,fontSize:13,color:"#0f172a",marginBottom:8}},"Current Offices ("+offices.length+")"),
          loading?React.createElement("div",{style:{textAlign:"center",color:"#64748b",padding:20}},"Loading..."):
          offices.map(function(o){
            return React.createElement("div",{key:o.code,style:{background:"#f8fafc",borderRadius:10,padding:"10px 12px",marginBottom:8,display:"flex",justifyContent:"space-between",alignItems:"center"}},
              ...
              React.createElement("button",{
                style:{background:"#fef2f2",color:"#dc2626",border:"1px solid #fecaca",borderRadius:8,padding:"4px 10px",fontSize:11,cursor:"pointer"},
        ...
        tab==="brevo"&&React.createElement("div",null,
          ...
          React.createElement("input",{style:Object.assign({},S.input,{marginBottom:8,fontSize:12}),placeholder:"Office Code (or 'default')",value:newBrevo.officeCode,
            onChange:function(e){setNewBrevo(function(b){return Object.assign({},b,{officeCode:e.target.value.toUpperCase()});})}}),
          React.createElement("input",{style:Object.assign({},S.input,{marginBottom:8,fontSize:12}),placeholder:"Label (e.g. PANDALAM KEY)",value:newBrevo.label,
            onChange:function(e){setNewBrevo(function(b){return Object.assign({},b,{label:e.target.value});})}}),
          React.createElement("input",{style:Object.assign({},S.input,{marginBottom:8,fontSize:11,fontFamily:"monospace"}),placeholder:"xkeysib-...",value:newBrevo.apiKey,
            onChange:function(e){setNewBrevo(function(b){return Object.assign({},b,{apiKey:e.target.value});})}}),
          React.createElement("button",{style:Object.assign({},S.btn,{width:"100%",marginBottom:16,fontSize:13}),onClick:saveBrevoKey},"+ Add Key"),
          React.createElement("div",{style:{fontWeight:700,fontSize:13,color:"#0f172a",marginBottom:8}},"Current Keys ("+brevoKeys.length+")"),
          loading?React.createElement("div",{style:{textAlign:"center",color:"#64748b",padding:20}},"Loading..."):
          brevoKeys.map(function(k){
            return React.createElement("div",{key:k.officeCode,style:{background:"#f8fafc",borderRadius:10,padding:"10px 12px",marginBottom:8}},
              React.createElement("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:4}},
                React.createElement("div",{style:{fontWeight:700,fontSize:13,color:"#0f172a"}},
                  k.officeCode==="default"?"🔑 Default Key":"🏢 "+k.officeCode+(k.label?" — "+k.label:"")),
                React.createElement("button",{
                  style:{background:"#fef2f2",color:"#dc2626",border:"1px solid #fecaca",borderRadius:8,padding:"4px 10px",fontSize:11,cursor:"pointer"},
        ...
        tab==="stats"&&React.createElement("div",null,
          ...
          Object.keys(stats).length===0
            ?React.createElement("div",{style:{textAlign:"center",color:"#94a3b8",padding:20}},"No reports today")
            :React.createElement("div",null,
...
function App(){
  ...
  // Send report via Brevo
  async function sendReport(payload){
    var key=payload.brevoKey||"";
    await sendViaBrevo(key,payload.to,payload.subject,payload.bodyText,payload.pdfBase64,payload.pdfFilename);
    // Log to sheets
