...
const BACKEND_URL = "https://script.google.com/macros/s/AKfycby7wrDDFph84dz9DosBmtkdhlci4iAo1EuwNW-ntqvJUV1eGOCjWtwbhCl-rSG7xCRaMA/exec";
...
function AdminPanel(props){
  ...
  function getGroups(){
    ...
    Object.keys(OFFICE_CODES).forEach(function(code){
      ...
      if(!groups[keyId]) groups[keyId]={offices:[],totalSent:0,keyPreview:office.brevoKey?office.brevoKey.toString().substring(0,16)+"...":"No key set"};
        ...
        React.createElement("div",null,
          ...
          groups.map(function(group,gi){
            ...
            return React.createElement("div",{key:gi,style:{background:"#fff",borderRadius:12,padding:"14px",marginBottom:12,boxShadow:"0 1px 3px rgba(0,0,0,0.06)",border:"1.5px solid #e2e8f0"}},
              // Key identifier
              React.createElement("div",{style:{fontSize:10,color:"#94a3b8",fontFamily:"monospace",marginBottom:10,background:"#f8fafc",padding:"4px 8px",borderRadius:6}},
                "🔑 "+group.keyPreview
              ),
