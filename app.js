...
const BACKEND_URL = "https://script.google.com/macros/s/AKfycbxledOqGlMAekV3Kav8MEp193FQKAgMg8Yd8VAA6XSSH1UZojW265fVw49f4eu9cPUcNA/exec";
...
// ── Email Senders ────────────────────────────────────────────
async function sendViaBrevo(apiKey, to, subject, bodyText, pdfBase64, pdfFilename, senderEmail) {
  if(!senderEmail) throw new Error("No sender email configured. Please contact admin.");
  var payload={
...
function AdminPanel(props){
  ...
  var unoff=useState({code:"",name:"",recipientEmail:"",senderEmail:"",brevoKey:""});
  var newOffice=unoff[0],setNewOffice=unoff[1];

  async function login(){
    setLoading(true);
    var result=await backendPost({action:"validateAdmin",password:adminPass});
    setLoading(false);
    if(result.success){setAuthed(true);loadAll();}
    else setAdminErr(result.error||"Wrong password");
  }
  ...
  async function saveOffice(){
    if(!newOffice.code||!newOffice.name||!newOffice.recipientEmail){alert("Fill Code, Name and Recipient Email");return;}
    setLoading(true);
    await backendPost({
      action:"addOffice",
      code:newOffice.code,
      name:newOffice.name,
      recipientEmail:newOffice.recipientEmail,
      senderEmail:newOffice.senderEmail,
      brevoKey:newOffice.brevoKey,
    });
    setNewOffice({code:"",name:"",recipientEmail:"",senderEmail:"",brevoKey:""});
    await loadAll();
  }
  ...
  return React.createElement("div",{style:S.adminOverlay},
    React.createElement("div",{style:Object.assign({},S.adminModal,{maxWidth:480,maxHeight:"90vh",overflowY:"auto",padding:0})},
      ...
      React.createElement("div",{style:{display:"flex",borderBottom:"1px solid #e2e8f0",background:"#f8fafc"}},
        [["offices","🏢 Offices"],["stats","📊 Stats"]].map(function(t){
      ...
      React.createElement("div",{style:{padding:"16px"}},
        ...
        tab==="offices"&&React.createElement("div",null,
          ...
          React.createElement("input",{style:Object.assign({},S.input,{marginBottom:8,fontSize:12}),
            placeholder:"Office Code (e.g. 300601)",value:newOffice.code,
          ...
          React.createElement("input",{style:Object.assign({},S.input,{marginBottom:8,fontSize:12}),
            placeholder:"Recipient Email (office receives reports)",value:newOffice.recipientEmail,
            onChange:function(e){setNewOffice(function(o){return Object.assign({},o,{recipientEmail:e.target.value});})}}),
          React.createElement("input",{style:Object.assign({},S.input,{marginBottom:8,fontSize:12}),
            placeholder:"Sender Email (verified in Brevo)",value:newOffice.senderEmail,
            onChange:function(e){setNewOffice(function(o){return Object.assign({},o,{senderEmail:e.target.value});})}}),
          React.createElement("input",{style:Object.assign({},S.input,{marginBottom:8,fontSize:11,fontFamily:"monospace"}),
            placeholder:"Brevo API Key (xkeysib-...)",value:newOffice.brevoKey,
            onChange:function(e){setNewOffice(function(o){return Object.assign({},o,{brevoKey:e.target.value});})}}),
          ...
          React.createElement("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8}},
            React.createElement("div",{style:{fontWeight:700,fontSize:13,color:"#0f172a"}},"Current Offices ("+offices.length+")"),
          ...
          offices.map(function(o){
            return React.createElement("div",{key:o.code,style:{background:"#f8fafc",borderRadius:10,padding:"10px 12px",marginBottom:8}},
              React.createElement("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:4}},
                React.createElement("div",null,
                  ...
                  React.createElement("div",{style:{fontSize:11,color:"#64748b",marginTop:2}},"To: "+o.recipientEmail),
                  React.createElement("div",{style:{fontSize:11,color:"#1d4ed8",marginTop:2}},"From: "+(o.senderEmail||"Not set")),
                  React.createElement("div",{style:{fontSize:10,color:o.brevoKey?"#15803d":"#dc2626",marginTop:2}},
                    o.brevoKey?"✅ Brevo key set":"❌ No Brevo key")
                ),
                React.createElement("button",{
                  style:{background:"#fef2f2",color:"#dc2626",border:"1px solid #fecaca",borderRadius:8,padding:"4px 10px",fontSize:11,cursor:"pointer",flexShrink:0},
                ...
                Object.keys(stats).map(function(code){
                  ...
                  return React.createElement("div",{key:code,style:{background:"#f0fdf4",borderRadius:10,padding:"12px",marginBottom:8,display:"flex",justifyContent:"space-between",alignItems:"center"}},
                    React.createElement("div",null,
                      ...
                      React.createElement("div",{style:{fontSize:11,color:"#64748b"}},"Code: "+code)
                    ),
...
function App(){
  ...
  try{
    ...
    // Only use stored office if it has senderEmail and brevoKey
    if(stored&&stored.senderEmail&&stored.brevoKey){
      officeInit=stored;
    } else if(stored) {
      // Clear outdated office data — missing fields
  ...
  async function handleSubmit(){
    ...
    try{
      ...
      try{
        ...
        // Show exact error before queuing
        console.error("Send failed:",e.message);
        if(e.message&&(e.message.indexOf("sender")!==-1||e.message.indexOf("Brevo")!==-1||e.message.indexOf("key")!==-1)){
          // Config error - don't queue, show error
          setError(e.message);
